...
public:
	...
	*/
	...
	void ReplaceItem(ItemType item);

	void ResetQueue();
	void AddQueue(Node<ItemType>* node);
	int GetNextItem(ItemType& item);


private:
	Node<ItemType>* root;		// Node 타입의 root
	CircularQueue<ItemType> preQue;
};
...
template<class ItemType>
void BinarySearchTree<ItemType>::PrintTree(std::ostream& out)const
{
	cout << "[InOrder]" << endl;
...
template<class ItemType>
void BinarySearchTree<ItemType>::PrintInOrder(std::ostream& out)const
{
	cout << "\t<========[InOrder]========>" << endl;
	PrintInOrderTraversal(root, out);			// InOrder 방법으로 출력
	out << endl;
...
template<class ItemType>
void BinarySearchTree<ItemType>::PrintPreOrder(std::ostream& out)const
{
...
template<class ItemType>
void BinarySearchTree<ItemType>::PrintPostOrder(std::ostream& out)const
{
...
template<class ItemType>
void BinarySearchTree<ItemType>::ReplaceItem(ItemType item) {
	DeleteItem(item);
	Add(item);
}

template<class ItemType>
void BinarySearchTree<ItemType>::AddQueue(Node<ItemType>* node) {
	if (node != NULL) {
		preQue.AddToCircularQueue(node->data);
		AddQueue(node->left);
		AddQueue(node->right);
	}
...
template<class ItemType>
void BinarySearchTree<ItemType>::ResetQueue() {
	preQue.ResetQueue();
	AddQueue(root);
}

template<class ItemType>
int BinarySearchTree<ItemType>::GetNextItem(ItemType& item) {
	return preQue.DeleteFrCircularQueue(item);
}
...
template<class ItemType>
void PrintInOrderTraversal(Node<ItemType>* root, std::ostream& out)
{
...
template<class ItemType>
void PrintPreOrderTraversal(Node<ItemType>* root, std::ostream& out)
{
	if (root != NULL)								// root가 존재하는 경우
	{
...
template<class ItemType>
void PrintPostOrderTraversal(Node<ItemType>* root, std::ostream& out)
{
	if (root != NULL)								// root가 존재하는 경우
	{
