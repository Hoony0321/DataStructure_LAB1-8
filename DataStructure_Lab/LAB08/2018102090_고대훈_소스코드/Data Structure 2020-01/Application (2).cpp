...
void Application::GetCommand()
{
	...
	cout << "\t   26 : 즐겨찾는 물품 리스트 출력" << endl;
	cout << "\t   27 : 검색 기록 출력" << endl;
	cout << "\t   28 : 전 검색 기록으로 돌아가기" << endl;
	cout << "\t---------------------- " << endl;
	cout << "\t   0 : Quit" << endl;
...
int Application::ReplaceItem()
{
	...
	if (!found) { //해당 item의 id와 일치하는 것을 가져온다. 이전내용과 비교를 위해
...
void Application::WhatHeap()
{
	...
	{
	case 1:		// Max Heap
		MasterList = new CMaxHeap<ItemType>(50);
		break;
	case 2:		// Min Heap
		MasterList = new CMinHeap<ItemType>(50);
		break;
	case 0:		// 종료
		return;
	default:	// 그 외
