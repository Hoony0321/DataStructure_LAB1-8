...
// Heap에서 제품정보를 수정하기 위한 함수
int Application::UpdateItem() {
	ItemType tItem;
	tItem.SetRecordFromKB();

	m_List->Delete(tItem);   //기존 정보 삭제
	m_List->Add(tItem);       //Update된 정보 추가
